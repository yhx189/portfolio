...
-- separately in ~pdinda/339/HANDOUT/pf/fec.  
...
--
  referer varchar(64) not null references pf_users(name),
--
...
-- of
--
create table pf_cs_ind_to_geo (
-- 
-- Requester must be a user
--
  requester varchar(64) not null references pf_users(name) on delete cascade,
-- 
-- Submitter must be a user
-- If this is null, it indicates that the geolocation is requested
--
  submitter varchar(64) references pf_users(name) on delete cascade,
--
-- Validator must be a user
-- If this is null, it indicates that the geolocation needs to be 
-- validated
--
  validator varchar(64) references pf_users(name) on delete cascade,
--
...
-- Opinions
--
create table pf_opinions (
-- 
-- Submitter must be a user
--
  submitter varchar(64) not null references pf_users(name) on delete cascade,
--
...
--
--
INSERT INTO pf_actions VALUES ('manage-users');
INSERT INTO pf_actions VALUES ('invite-users');
INSERT INTO pf_actions VALUES ('add-users');
INSERT INTO pf_actions VALUES ('query-fec-data');
INSERT INTO pf_actions VALUES ('query-cs-ind-data');
INSERT INTO pf_actions VALUES ('query-opinion-data');
INSERT INTO pf_actions VALUES ('give-cs-ind-data');
INSERT INTO pf_actions VALUES ('give-opinion-data');

--
-- Create the required users
--
INSERT INTO pf_users (name,password,email,referer) VALUES ('root','rootroot','root@root.com','root');
INSERT INTO pf_users (name,password,email,referer) VALUES ('anon','anonanon','anon@anon.com','root');
...
--
INSERT INTO pf_permissions (name,action) VALUES('anon','query-fec-data');
INSERT INTO pf_permissions (name,action) VALUES('anon','query-opinion-data');
--
-- Root can do anything
--
INSERT INTO pf_permissions (name,action) VALUES('root','manage-users');
INSERT INTO pf_permissions (name,action) VALUES('root','invite-users');
INSERT INTO pf_permissions (name,action) VALUES('root','add-users');
INSERT INTO pf_permissions (name,action) VALUES('root','query-fec-data');
INSERT INTO pf_permissions (name,action) VALUES('root','query-cs-ind-data');
INSERT INTO pf_permissions (name,action) VALUES('root','query-opinion-data');
INSERT INTO pf_permissions (name,action) VALUES('root','give-cs-ind-data');
INSERT INTO pf_permissions (name,action) VALUES('root','give-opinion-data');
--
